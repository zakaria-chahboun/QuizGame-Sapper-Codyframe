...
const StatusTypes = {
  ...
  Already_Exist_Email: {
    ...
    message:
      "Your email is already in use by an existing user, Each user must have a unique email!",
  },
  Already_Used_Email: {
  ...
  Already_Exist_Phone_Number: {
    ...
    number: StatusNumbers.BAD_REQUEST,
    message:
      "Your phone number is already in use by an existing user, Each user must have a unique one!",
  },
  Already_Exist_UID: {
  ...
  Invalid_Phone_Number: {
    ...
    number: StatusNumbers.BAD_REQUEST,
    message:
      "Your phone number is invalid. It must be a non-empty E.164 standard compliant identifier string",
  },
  Invalid_Password: {
    code: "auth/invalid-password",
    number: StatusNumbers.BAD_REQUEST,
    message:
      "Sorry! Invalid password, It must be a string with at least 6 characters.",
  },
  Wrong_Password: {
  ...
  Token_ID_Expired: {
    ...
    number: StatusNumbers.UNAUTHORIZED,
    message:
      "The credential of this account is expired or the account is deleted! Try to sign in again!",
  },
  Network_Error: {
  ...
  User_Disabled: {
    ...
    number: StatusNumbers.UNAUTHORIZED,
    message:
      "Your account is disabled by the administrator, Try to contact us!",
  },
  Internal_Error: {
...
// Export All!
export { StatusNumbers, StatusTypes };
